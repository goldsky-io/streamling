...
#[tokio::test]
async fn direct_distinct_mixed_aggregate_grid() {
    for (q, expected) in [
        (
...
#[tokio::test]
async fn supported_distinct_sum_subquery_with_count_having() {
    check(
...
#[tokio::test]
async fn supported_distinct_avg_subquery_with_count_having() {
    check(
...
#[tokio::test]
async fn supported_native_distinct_count_having_control() {
    let sm = session();
...
#[tokio::test]
async fn supported_ordered_array_aggregate_numeric_order() {
    ordered_array(false).await;
}
#[tokio::test]
async fn supported_ordered_array_native_control() {
...
async fn supported_window_subquery_numeric_order() {
