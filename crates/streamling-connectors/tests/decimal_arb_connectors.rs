...
#[test]
fn json_string_decimal_keeps_numeric_text() {
...
#[test]
fn postgres_nested_json_projection_control() {
    let (f, a) = decimal(100, 2, &[Some("1.23"), Some("-4.56"), None]);
...
#[tokio::test]
async fn supported_json_string_preserves_decimal_value() {
...
#[test]
fn clickhouse_string_strictness_and_null_control() {
...
#[test]
fn clickhouse_native_signed_boundary_control() {
    let maximum_signed =
...
#[test]
fn clickhouse_native_reader_enforces_declared_precision() {
...
fn native_reader_rejects_fractional_hint_instead_of_changing_value() {
...
#[test]
fn decimal_dedup_same_scale_control() {
...
#[tokio::test]
async fn supported_unnest_preserves_unrelated_decimal_field() {
...
#[tokio::test]
async fn supported_unnest_decimal_list_preserves_value() {
...
#[test]
fn retired_fixed_width_pk_dedup_control() {
    use streamling_core::utils::dedup::deduplicate_record_batch;
    let mut one = [0u8; 32];
    one[31] = 1;
    let mut two = [0u8; 32];
...
#[tokio::test]
async fn clickhouse_default_native_pk_projection_is_deduplicable() {
