...
#[tokio::test]
async fn wasm_nested_struct_echo() {
    echo("struct").await;
}
#[tokio::test]
async fn wasm_nested_list_echo() {
    echo("list").await;
}
#[tokio::test]
async fn wasm_nested_list_struct_echo() {
    echo("list_struct").await;
}

#[tokio::test]
async fn wasm_all_null_decimal_echo() {
...
#[test]
fn native_plugin_ffi_preserves_nested_decimal_fields_and_values() {
