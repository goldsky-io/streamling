...
#[tokio::test]
async fn v3_native_decimal_key_control() {
    key(30, true).await;
}
#[tokio::test]
async fn v3_decimal_arb_primary_key_deduplication() {
    key(100, true).await;
}
...
#[tokio::test]
async fn v3_native_all_null_script_control() {
    null_script(30, true).await;
}
#[tokio::test]
async fn v3_decimal_arb_mixed_null_script_control() {
    null_script(100, false).await;
}
#[tokio::test]
async fn v3_decimal_arb_all_null_script_batch() {
