...
#[tokio::test]
async fn hybrid_wide_fraction_string() {
    hybrid("String", 100, 18, signed_values(99)).await;
}
#[tokio::test]
async fn hybrid_native_decimal_to_wide() {
    hybrid("Decimal(76,18)", 100, 18, signed_values(76)).await;
}
#[tokio::test]
async fn hybrid_native_decimal_scale38_to_wide() {
    hybrid("Decimal(76,38)", 100, 38, signed_values(76)).await;
}
#[tokio::test]
async fn hybrid_tiny_fraction_string() {
    hybrid("String", 100, 100, signed_values(99)).await;
}
#[tokio::test]
async fn hybrid_unsigned_native_hint() {
...
#[tokio::test]
async fn hybrid_signed_native_to_wide() {
