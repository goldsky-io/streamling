...
#[test]
fn deep_json_supported_containers_slices_nulls_matrix() {
    for kind in [
        "leaf",
        "struct",
        "list",
...
#[test]
fn deep_ipc_supported_containers_slices_nulls_matrix() {
...
#[test]
fn deep_json_view_dictionary_decimal_output() {
    let mut failures = Vec::new();
...
#[test]
fn deep_ipc_nested_echo_to_avro_preserves_1000() {
...
#[test]
fn deep_native_ipc_nested_scale_change_preserves_12_34() {
...
#[test]
fn deep_scalar_ipc_string_encodings_parse_exactly() {
...
#[test]
fn deep_native_ipc_narrow_precision_does_not_accept_out_of_range() {
...
#[test]
fn deep_ipc_zero_width_fixed_lists_preserve_row_count() {
...
#[test]
fn deep_json_zero_width_fixed_lists_emit_rows() {
    let (field, values) = decimal(80, 0, &[]);
    let array =
        FixedSizeListArray::try_new_with_length(Arc::new(field), 0, values, None, 3).unwrap();
    let input = batch(
...
#[test]
fn deep_avro_twos_complement_precision_scale_boundary_grid() {
